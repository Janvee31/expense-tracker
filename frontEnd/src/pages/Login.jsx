...
import { LogIn, KeyRound, Mail, Wallet, ArrowRight, CheckCircle2, Sparkles } from "lucide-react";
    ...
    return (
        <div className="min-h-screen flex bg-white font-sans text-black selection:bg-emerald-500/20">
            ...
            <div className="w-full lg:w-2/5 flex items-center justify-center p-8 relative">
                {/* Mobile decorative ambient light */}
                ...
                <div className="max-w-md w-full relative z-10 space-y-8">
                    ...
                    <div className="flex flex-col space-y-2 text-left">
                        ...
                        <p className="text-slate-400 text-sm font-medium leading-relaxed">
                            Access your flat group ledger and bills settlement reports.
                        </p>
                    </div>
